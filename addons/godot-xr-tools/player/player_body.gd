...
@export var player_relative_height_min : float = 0.1
@export var player_relative_height_max : float = 1.1
var player_relative_height_base : float = -1.0
var player_relative_starting_height = 1.0
...
func _update_body_under_camera():
	...
	# initialize relative height
	if player_relative_height_base < 0.0:
		player_relative_height_base = player_height - player_relative_starting_height
	
	# update minimum relative height
	if player_height < player_relative_height_base + player_relative_height_min:
		player_relative_height_base -= (player_relative_height_base + player_relative_height_min) - player_height
	# update maximum relative height
	if player_height > player_relative_height_base + player_relative_height_max:
		player_relative_height_base -= (player_relative_height_base + player_relative_height_max) - player_height
	
	player_height = player_height - player_relative_height_base
